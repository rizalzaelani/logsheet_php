...
<link href="<?= base_url(); ?>/css/style.css" rel="stylesheet" type="text/css" id="light-style" />
<style>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 align-self-center text-center text-md-left">
                    <h1><?= $errorCode ?? 404 ?></h1>
                    <h2><?= $errorMessage ?? "UH OH! You're lost." ?></h2>
                    <p>The page you are looking for does not exist.
                        How you got here is a mystery. But you can click the button below
                        to go back to the homepage.
                    </p>
                    <a href="<?= $returnLink ?? site_url(); ?>" class="btn green"><?= ($returnLink ?? "") == "" ? "HOME" : "BACK" ?></a>
                </div>
            </div>
        </div>
    </main>
    <script src="<?= base_url(); ?>/vendors/gsap/gsap.min.js"></script>
    <script>
        gsap.set("svg", {
            visibility: "visible"
        });
