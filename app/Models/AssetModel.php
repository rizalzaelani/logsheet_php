...
class AssetModel extends Model
{
    ...
    protected $allowedFields    = ['assetId', 'userId', 'assetStatusId', 'assetName', 'assetNumber', 'description', 'schManual', 'schType', 'schFrequency', 'schWeeks', 'schWeekDays', 'schDays', 'latitude', 'longitude', 'createdAt', 'updatedAt', 'deletedAt'];
